...
int main(int argCount, char** args){
	...
	case 4:
	    //4: delete min
	    cout << "Deleted min element: " << myMin3Heap->deleteMinElem();
	    break;
        case 5:
            //5: delete max
	    cout << "Deleted max element: " << myMin3Heap->deleteMaxElem();
	    break;
	case 6:
...
void initialize(Min3Heap*  &myMin3Heap, int argCount, char** args){
    ...
    inputData >> elemCount;
    string* inputDataArr = new string[elemCount + 1];
    ...
    myMin3Heap = new Min3Heap(inputDataArr);
    delete[] inputDataArr;
