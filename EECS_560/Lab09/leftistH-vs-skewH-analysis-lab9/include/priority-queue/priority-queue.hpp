...
#include "leftist-heap/leftist-heap.hpp"
#include "skew-heap/skew-heap.hpp"
...
private:
  // Member fields
  //IMPORTANT: can switch type of this variable between LeftistHeap and SkewHeap to change implementation
  //NOTE: will also need to change paramters in traversal methods if I plan to use those
  //NOTE: will also need to change type of getHeap() method
  SkewHeap *myHeap;
